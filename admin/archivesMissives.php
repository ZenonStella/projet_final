                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Vous vous apprêtez à désarchiver un message qui <?= $missive['mi_respoce'] = 1 ? 'n\'a pas eu de réponse' : 'a eu une réponse' ?>. Voulez-vous continuer ?
                                    </div>
                        ...
                        <div class="modal fade" id="missive<?= $missive['mi_id'] ?>Delete" tabindex="-1" aria-labelledby="missive<?= $missive['mi_id'] ?>DeleteLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Vous vous apprêtez à supprimer définitivement un message qui <?= $missive['mi_respoce'] = 1 ? 'n\'a pas eu de réponse' : 'a eu une réponse' ?>. Voulez-vous continuer ?
                                    </div>
                                    <div class="modal-footer">
