...
<div class="row justify-content-center">
  <div id="carouselExampleControls" class="carousel slide slider col-11" data-bs-ride="carousel">
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <img src="../assets/img/torchie.jpg" class="d-block w-100" alt="...">
      </div>
    </div>
  ...
  <div class="col-11 my-5">
    <div class="row">
      ...
      <div class="flex-grow-1 col-8">
        <p class="coll-11">Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam magnam, tenetur esse eaque suscipit fugit, inventore eos blanditiis eum eveniet ipsa, minima optio aut possimus nihil. Quo provident quod exercitationem. </p>
      </div>
      <div class="flex-grow-1 col-8">
        <p class="coll-11">Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam magnam, tenetur esse eaque suscipit fugit, inventore eos blanditiis eum eveniet ipsa, minima optio aut possimus nihil. Quo provident quod exercitationem. </p>
      </div>
    ...
    <div class="box row">
      <p class="col-8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam magnam, tenetur esse eaque suscipit fugit, inventore eos blanditiis eum eveniet ipsa, minima optio aut possimus nihil. Quo provident quod exercitationem. </p>
      <div class="box-img col-4">
        <img src="../assets/img/facade_en_torchie.jpg" alt="">
      </div>
